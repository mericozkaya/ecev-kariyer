...
import { getInterns, getDepartments } from "../lib/firebase/firebase";
...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white text-black px-4 sm:px-6 pb-12">
      <div className="max-w-screen-xl mx-auto">
        {/* Logo ve Başlık */}
        <header className="flex flex-wrap items-center justify-between p-4 border-b border-[#d71a28]">
